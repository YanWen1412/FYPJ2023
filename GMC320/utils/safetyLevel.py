...
def safetyLevel(cpm : int):
    ...
    if cpm <= 50:
        ...
        return [3, "High", "Closely watch reading, find out why"]
    elif cpm > 1000 and cpm <= 2000:
        return [4, "Very high", "Leave area asap and find out why"]
    else:
        return [5, "Extremely high", "Evacuate immediately and inform government"]